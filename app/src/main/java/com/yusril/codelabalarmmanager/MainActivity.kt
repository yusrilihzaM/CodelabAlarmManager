package com.yusril.codelabalarmmanager

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.view.View
import com.yusril.codelabalarmmanager.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), View.OnClickListener, DatePickerFragment.DialogDateListener, TimePickerFragment.DialogTimeListener {
    ...
    override fun onDialogDateSet(tag: String?, year: Int, month: Int, dayOfMonth: Int) {
        ...
        val dateFormet=SimpleDateFormat("yyyy-MM-dd",Locale.getDefault())

        // Set text dari textview once
        binding?.tvOnceDate?.text = dateFormet.format(calendar.time)
    }
